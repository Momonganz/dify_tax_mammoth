...
5. 見積書とワンライティングで作成する注文書

# 見積書とワンライティングで作成する注文書

## 【照会要旨】

当社では、機械修理の見積り依頼を受けた場合に、![1](https://www.nta.go.jp/category/icon_img/no_img/01.gif)の「見積書」と![2](https://www.nta.go.jp/category/icon_img/no_img/02.gif)の「注文書」を事務簡素化のため、ワンライティングで作成してその依頼者に交付しています。

依頼者が機械修理を注文する場合は、![2](https://www.nta.go.jp/category/icon_img/no_img/02.gif)の「注文書」に署名押印の上当社に返送することになっていますが、この注文書の番号が![1](https://www.nta.go.jp/category/icon_img/no_img/01.gif)の「見積書」の番号と同一になっていますので、第2号文書（請負に関する契約書）に該当するのでしょうか。

![見積書、注文書の図](https://www.nta.go.jp/law/shitsugi/inshi/12/img/15_01.gif)
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/inshi/12/15.htm#page-top)
