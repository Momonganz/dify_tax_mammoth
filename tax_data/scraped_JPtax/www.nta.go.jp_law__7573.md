...
印紙税納付計器によって印紙税を納付しようとする場合には、まず、その事業所の所在地を管轄する税務署長に [「印紙税納付計器設置承認申請」](https://www.nta.go.jp/taxes/tetsuzuki/shinsei/annai/inshi/annai/23120076.htm) をします。税務署長は、この申請に基づいて承認しても差し支えないと認めたときは、承認番号を付してこれを通知します。質問にある「税務署名と番号」というのは、この承認番号のことです。
...
![印紙税納付印の印影の図](https://www.nta.go.jp/law/shitsugi/inshi/06/img/09_01.gif)

なお、印紙税納付計器を使用して納付印を押すことができる文書は、印紙税納付計器を設置している者が作成する文書だけでなく、別に [承認](https://www.nta.go.jp/taxes/tetsuzuki/shinsei/annai/inshi/annai/23120078.htm) を受けることにより設置をしている者が取引の相手方から受け取る文書についても押すことができることになっています（法第10条）。
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/inshi/06/09.htm#page-top)
