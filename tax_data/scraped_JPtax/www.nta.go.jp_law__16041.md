...
通算制度では、通算グループ内の各通算法人の会計処理の方法について、これを統一することまでは求められていません。


したがって、消費税等に係る経理処理についても、通算法人ごとに税抜経理方式、税込経理方式又は併用方式のいずれかにより処理することが認められます。

[このページの先頭へ](https://www.nta.go.jp/law/joho-zeikaishaku/hojin/group_faq/84.htm#page-top)
