...
$\\circledast$ 再生計画の終了年度（原則として実質的な債務超過を解消する年度）における有利子負債 $\\mathcal{O})$ 対キャッシュフロー比率が概ね１０倍以下となる内容とする（企業 $\\mathcal{O})$ 業種特性や固有 $\\mathcal{O})$ 事情等に応じた合理的な理由がある場合には、これを超える比率となる計画を排除しない。）。
