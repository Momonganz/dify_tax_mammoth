...
この場合における「1画地の宅地」の判定は、原則として、![1](https://www.nta.go.jp/category/icon_img/no_img/01.gif)宅地の所有者による自由な使用収益を制約する他者の権利(原則として使用貸借による使用借権を除く)の存在の有無により区分し、![2](https://www.nta.go.jp/category/icon_img/no_img/02.gif)他者の権利が存在する場合には、その権利の種類及び権利者の異なるごとに区分するので、具体的には、例えば次のように判定します。
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/hyoka/02/01.htm#page-top)
