...
5. 地積規模の大きな宅地の評価－計算例①（一般的な宅地の場合）

# 地積規模の大きな宅地の評価－計算例①（一般的な宅地の場合）

## 【照会要旨】

次の図のような宅地（地積750![平方メートル](https://www.nta.go.jp/shared/images/mark/m2.gif)、三大都市圏に所在）の価額はどのように評価するのでしょうか（地積規模の大きな宅地の評価における要件は満たしています。）。

![普通住宅地図](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/08_01.gif)

## 【回答要旨】

1. 1 規模格差補正率の計算（小数点以下第2位未満切捨て）

![規模格差補正率の計算式](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/08_02.gif)
2. 2 評価額

![評価額の計算式](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/08_03.gif)
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/hyoka/20/08.htm#page-top)
