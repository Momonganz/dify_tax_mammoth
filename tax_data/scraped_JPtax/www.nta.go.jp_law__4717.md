# 【新設】（持分 $\\underline{{\\boldsymbol{\\mathcal{O}}}}$ 交付が省略されたと認められるものの例示）

18－1－39令第155 条の16 第９項第１号イ｟当期純損益金額｠の「持分の交付が省略されたと認められるもの」とは、例えば、同号の組織再編成の前後において株主等の持分割合に変更が生じないため、当該組織再編成 $\\mathcal{O}$ 対価として持分を交付しなかったものをいう。
...
⑵ $2\ \\mathcal{O})$ 会社等が同一 $\\mathcal{O}$ 者によってそれぞれそ $\\mathcal{O}$ 総持分数の $50,%$ を超える数又は金額 $\\mathcal{O}$ 持分を直接又は間接に保有される場合におけるそ $\\mathcal{O}$ $2\ \\mathcal{O})$ 会社等 $\\mathcal{O}$ 関係そ $\\mathcal{O}$ 他 $\\mathcal{O}\ 2\ \\mathcal{O})$ 会社等が同一 $\\mathcal{O}$ 者によ $\\textdegree$ て直接又は間接に支配される場合におけるそ $\\mathcal{O}\ 2\ \\mathcal{O})$ 会社等 $\\mathcal{O}$ 関係（ $(1)$ に掲げる関係に該当するものを除く。）

６ ところで、上記 $5~\\textdegreesupset$ 対価要件について、いわゆる無対価組織再編成 $\\mathcal{O}$ 場合、持分の交付が省略されたと認められるもののみがこ $\\mathcal{O}$ 要件を満たすこととなるが、この「持分 $\\mathcal{O}$ 交付が省略されたと認められるも $\\mathcal{O}$ 」には、どのようなものが該当するのか疑義が生ずる。

この点、例えば、親会社を合併法人とし、その $100,%$ 子会社を被合併法人とする合併を行う場合に、実務上、合併の対価を交付しないことがある。これは、合併 $\\mathcal{O}$ 対価を交付してもしなくても、合併 $\\mathcal{O}$ 前後において株主等の持分割合に変更が生じないためその交付が省略されるものである。このようなことから、本通達では、上記 $5~\\textdegreesupset$ 「持分 $\\mathcal{O}$ 交付が省略されたと認められるもの」とは、組織再編成の前後において株主等の持分割合に変更が生じないため、その対価として持分を交付しなか $\\textdegree$ た組織再編成をいうことを例示により明らかにしている。