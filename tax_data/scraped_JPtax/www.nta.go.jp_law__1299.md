...
問17会計システムのサブシステムにあるマスターデータについて、課税期間終了時点のもののみを保存することとしてもよいのでしょうか。････････19
...
![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/88b019f474de90953a971b93fdd1696a21025776fc6caa274a8337415fa75305.jpg)

認証ロゴを使用できる場所認証製品の梱包材、製品マニュアル、技術マニュアル、仕様書 ＷＥＢページ 等問51 承認申請書（市販のソフトウェアのうちＪＩＩＭＡの認証を受けているもの）についてはどのような場合に使用できますか。
...
![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/910490ea959bf83abfb72169da6669490aea1d00fd9715d4523c0c2c63f7d856.jpg)

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/776f65c93cf9ea3d5f50e4f8de900d6c2b7627213ab9708bdd53203cf3ee601c.jpg)

# 【新設合併の場合】

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/37c63b48245a78a5cdba1143ca81bec936079e9a5a714251b419b32d393e8fd9.jpg)

設立年月日 $=$ 合併 $\\oslash$ 日

# Ｂ 社(被合併法人)

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/d6f1b4fb092f83411cf0f98c7bf6b6dfa08dbf0f74b574bed86795e2c9d35698.jpg)

【新設分割の場合】

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/9210a42ba9e88a6e138e945072dd06eead175d97054fd69007d77d5b9d422759.jpg)

Ｂ 社（分割継承法人）<新設法人\>

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/b403b529b2c6ec44139e48d02e39034c3baa3657c31dcac08f35b9c07e3d06d0.jpg)

# 【吸収分割の場合】

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/01b01e186dcdcab0d9404a7ed0382ff2af94d0f55c5f926a4b70e65c69e04987.jpg)

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/b5a8c70349494287ba3fc3e3bf61a12765726e9589532e573923195f47bcfa25.jpg)
...
問58 取りやめの届出書を提出した場合、その取りやめ $\\mathcal{O})$ 届出書を提出した日において保存等している電磁的記録等は、そのまま電磁的記録等により保存等することとしてもよいのでしょうか。
...
問59 取引の相手先からタイムスタンプが付与された電子取引の取引データが送信されてきた場合、当該電子取引の取引データを保存するためには、受信側において何を行う必要がありますか。
...
$\\circled{2}$ 当該電磁的記録の記録事項について正当な理由がない訂正及び削除 $\\mathcal{O})$ 防止に関する事務処理の規程を定め、当該規程に沿った運用を行うこと（規則８ $\\textcircled{1}$ 二）。
...
問60 電子取引の取引データの保存について、当該電子データをそのまま保存する方法と電子データを出力した書面を保存する方法との混在は認められますか。
...
法第10条に規定する電子取引の取引データの保存方法については、 $\\textcircled{1}$ 電子データをそのまま保存する方法、 $\\textcircled{2}$ 電子データを出力した書面を保存する方法及 $\\uptau\\mathrm{\\textcircled{3}}$ 電子データをＣＯＭに出力して保存する方法との３通りの方法があり、これらの方法は保存義務者 $\\mathcal{O})$ 任意により自由に選択することが可能となっています。
...
問61電子取引 $\\mathcal{O}$ 取引情報に係る電磁的記録の保存に当たり、規則第８条第１項第２号に規定する「正当な理由がない訂正及び削除の防止に関する事務処理の規程」を定めて運用する措置を行うことを考えていますが、具体的にどのような規程を整備すればよいのでしょうか。
...
（施行）第10 条 この規程は、令和○年○月○日から施行する。問62当社は、電子取引の取引情報の保存サービスの提供を受け、同サービス利用者同士の電子取引の取引情報については、同サービスにおいて保存されます。同サービス利用者は、同サービス提供者と契約し、同サービスの利用規約に定めるデータ訂正等の防止に関する条項にのっとりデータの訂正削除を行うこととなります。
...
規則第８条第１項第２号に規定する「正当な理由がない訂正及び削除の防止に関する事務処理の規程」について、取扱通達10－２は、⑴「自らの規程のみによって防止する場合」と⑵「取引相手との契約によって防止する場合」を例示していますが、質問に係る保存サービスの契約自体は、サービス提供者と利用者が行うものであり、サービス利用者同士がデータ訂正等の防止に関する条項を含む契約を行わない限り、取扱通達10－２⑵には該当しません。

しかしながら、規則第８条第１項第２号が規程を要件としているのは、当該規程によって電子取引の取引情報に係る電磁的記録の真実性を確保することを目的としたものであり、この真実性を確保する手段については、必ずしも、取扱通達10－２⑴と⑵には限られません。
...
この場合、各利用者が定める規程には、取扱通達10－２⑵に準じて $\\textcircled{1}$ ～ $\\textcircled{3}$ の内容を含むことが考えられます。
...
![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/939f776ee2d5e6ee7c2e69cd245b58923ae129e5122fb4cc35611c3fd61d1e4c.jpg)

２ 本照会に係る関係図

![](https://www.nta.go.jp/tmp/8f38665f-91b1-45d5-89de-963430c6f91e/images/79b6beb2d2fa0dda0a51305665ac40bed1effb512a1e2b5b13ce04cfee80226a.jpg)