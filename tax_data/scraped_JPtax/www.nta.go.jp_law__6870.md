...
また、発泡性を有する酒類で、製造したときに数量の測定を行うことが困難な場合には、移出するための容器に充![充填](https://www.nta.go.jp/law/tsutatsu/kihon/sake/img/ten2.gif)したとき等で数量を把握することができる状態になったときの数量としても差し支えない。
...
[このページの先頭へ](https://www.nta.go.jp/law/tsutatsu/kihon/sake/2-19.htm#page-top)
