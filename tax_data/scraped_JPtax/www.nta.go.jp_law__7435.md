...
5. 地積規模の大きな宅地の評価－計算例④（正面路線が2以上の地区にわたる場合）

# 地積規模の大きな宅地の評価－計算例④（正面路線が2以上の地区にわたる場合）

## 【照会要旨】

次の図のような宅地（地積1,500![平方メートル](https://www.nta.go.jp/shared/images/mark/m2.gif)、三大都市圏以外の地域に所在）の価額はどのように評価するのでしょうか（地区以外の地積規模の大きな宅地の評価における要件は満たしています。）。

![説明図](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/11_01.gif)
...
1. 1 地区の判定
    ...
    　上図の宅地の場合、普通住宅地区に属する部分の地積（900![平方メートル](https://www.nta.go.jp/shared/images/mark/m2.gif)）が中小工場地区に属する部分の地積（600![平方メートル](https://www.nta.go.jp/shared/images/mark/m2.gif)）よりも大きいことから、その宅地の全部が普通住宅地区に属するものと判定します。


    　したがって、上図の宅地は、その全部が「地積規模の大きな宅地の評価」の適用対象となります。

2. 2 規模格差補正率の計算（小数点以下第2位未満切捨て）

![規模格差補正率の計算式](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/11_02.gif)
3. 3 評価額

![評価額の計算式](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/11_03.gif)


※1　路線価の加重平均の計算

![加重平均の計算式](https://www.nta.go.jp/law/shitsugi/hyoka/20/img/11_04.gif)
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/hyoka/20/11.htm#page-top)
