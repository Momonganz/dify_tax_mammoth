...
輸出免税制度の適用者は、その適用要件として輸出したことを証する所定の書類を保存することとされていますが（法7![2](https://www.nta.go.jp/category/icon_img/no_img/02.gif)、規則5）、友好商社が介在する取引等の場合には、名義貸しに係る取引が多く、当該友好商社等を輸出申告者として掲名するものの、輸出申告書の原本は実際に輸出取引を行った者（実際の輸出者）が保管しています。
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/shohi/11/01.htm#page-top)
