...
**第** **25条** 指定用途に消費する工程中に、いつたん特定石化製品を指定用途外消費する工程がある場合には、その工程にかけられる時に、当該特定石化製品が指定用途に消費されるものとして取り扱つて差し支えない。
...
[このページの先頭へ](https://www.nta.go.jp/law/tsutatsu/kihon/kihatsu/kihatu01/05.htm#page-top)
