...
![EB債の一般的な仕組み](https://www.nta.go.jp/law/shitsugi/hyoka/15/img/07-1.gif)

- 転換価格は、設定日の株価以下の水準に設定される。
- 満期日前の一時点を評価日と定められる。
- 評価日の株価が転換価格以上（![1](https://www.nta.go.jp/shared/images/decimal/01.gif)の場合）ならば、EBは額面分の現金で償還される。
- 評価日の株価が転換価格未満（![2](https://www.nta.go.jp/shared/images/decimal/02.gif)の場合）ならば、EBは株式で償還される。
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/hyoka/15/07.htm#page-top)
