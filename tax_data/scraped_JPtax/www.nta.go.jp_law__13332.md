...
5. 附属建築物がある場合の建築面積及び施行地区面積の要件判定(12号)
...
![附属建築物がある場合の建築面積及び施行地区面積の要件判定(10号)の図](https://www.nta.go.jp/law/shitsugi/joto/13/img/14_01.gif)

## 【回答要旨】

施行地区の面積要件は、主たる建築物と附属建築物との敷地の用に供される土地等の面積により判定しますが、建築面積要件は主たる建築物の建築面積により判定します。

したがって、ケース2は建築面積要件(150![平方メートル](https://www.nta.go.jp/shared/images/mark/m2.gif)以上)を満たさないので、軽減税率の特例を適用することはできません。
...
[このページの先頭へ](https://www.nta.go.jp/law/shitsugi/joto/13/14.htm#page-top)
