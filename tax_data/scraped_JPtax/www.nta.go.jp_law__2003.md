...
4. 印紙税法施行令の規定に基づき計器を指定する件

# 印紙税法施行令の規定に基づき計器を指定する件
...
ビルコン計器RC-二型(電動式)及びRD-二型(電動式)で、次に掲げる構造及び機能を有するもの

## 1.　RC-二型(電動式)

(1)　構造

![RC-二型(電動式)のイラスト](https://www.nta.go.jp/law/kokuji/210423/img/01.gif)
...
表示することができる印紙税額に相当する金額の総額を限度として必要な措置を講ずることにより、限度とした
当該金額の総額の範囲内で当該金額を表示して納付印を押すことができるもの

## 2.　RD-二型(電動式)

(1)　構造

![RD-二型(電動式)のイラスト](https://www.nta.go.jp/law/kokuji/210423/img/02.gif)
...
[このページの先頭へ](https://www.nta.go.jp/law/kokuji/210423/01.htm#page-top)
