...
ハスラー計器F一〇一型（電動式）、F三〇五型（電動式）及びF三〇七型（電動式）で、次に掲げる構造及び機能を有するもの

## 1　F一〇一型（電動式）

（1）　構造

![F一〇一型（電動式）の図](https://www.nta.go.jp/law/kokuji/980716/img/14_1.gif)
...
![F三〇五型（電動式）の図](https://www.nta.go.jp/law/kokuji/980716/img/14_2.gif)

イ　印紙税額に相当する金額を表示して納付印を押す箇所

ロ　表示して印紙税額に相当する金額の累計額があらわれる箇所
...
![F三〇七型（電動式）の図](https://www.nta.go.jp/law/kokuji/980716/img/14_3.gif)
...
[このページの先頭へ](https://www.nta.go.jp/law/kokuji/980716/14.htm#page-top)
